...
require('./createPackage.js')('linux', { arch: Arch.x64 }).then(function (path) {
  var installerOptions = {
    artifactName: 'refreshview-${version}-${arch}.rpm',
    packageName: 'RefreshView',
    icon: 'icons/icon256.png',
    category: 'Network',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'PrivacySafe <support@privacysafe.net>',
    synopsis: 'RefreshView is a fast, minimal browser that protects your privacy.',
